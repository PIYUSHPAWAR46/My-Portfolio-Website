    ...
    <div  name ="Portfolio" className=' text-white bg-gradient-to-b from-black via-black to-gray-800 w-full h-screen md:h-screen'>
      <div  className='max-w-screen-lg mx-auto flex flex-col justify-center w-full h-full'>
        ...
        <div key={id} className='shadow-md shadow-gray-600 rounded-lg'>
                ...
                <img  src={src} alt="" className='hover:scale-105 duration-200  rounded-lg' />
           <div className='flex items-center justify-center'>
           {/* <button className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105'>Code</button> */}
            <a className='px-5 py-1 rounded-md m-4 duration-200 hover:scale-105 bg-gradient-to-b from-cyan-500 to-blue-400 flex justify-center' href={lin}>Code</a>
